...
export default class APCMini extends EventEmitter {
    ...
    static #getIO() {
        ...
        for (let i in inputs) {
            if (inputs[i].includes("APC mini mk2 Contr")) { input = +i; break; }
            else if (inputs[i].includes("APC mini mk2")) { input = +i; break; }
        }
        for (let i in outputs) {
            if (outputs[i].includes("APC mini mk2 Contr")) { output = +i; break; }
            else if (outputs[i].includes("APC mini mk2")) { output = +i; break; }
        }
